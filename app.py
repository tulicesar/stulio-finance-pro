...
with inf2:
    ...
    # AGUJA VECTORIAL DESDE EL CENTRO
    theta = 180 - (val_clamped / 100 * 180)
    rad = math.radians(theta)
    x_pivot, y_pivot = 0.5, 0.42 # Punto central
    x_punta = x_pivot + 0.32 * math.cos(rad)
    y_punta = y_pivot + 0.32 * math.sin(rad)
    
    fig2 = go.Figure()
    # Arco Blanco de fondo
    ...
    fig2.add_annotation(text="Ahorro Proyectado", x=x_pivot, y=y_pivot-0.2, showarrow=False, font=dict(color="grey", size=14))
    ...
    fig2.update_layout(paper_bgcolor='rgba(0,0,0,0)', height=320, margin=dict(t=50,b=20,l=25,r=25))
...
# ESPACIO FINAL PARA EL BOTÓN (BAJADO 18 LÍNEAS)
