...
# --- 3. GENERADOR DE PDF CON ENCABEZADO DE TEXTO ---
def generar_pdf_reporte(df_g_full, df_i_full, meses, titulo, anio):
    ...
    def head(canvas_obj, t, a):
        ...
        # ENCABEZADO DE TEXTO (Sustituye a la imagen)
    ...
    for m in meses:
        ...
        if not g_m.empty:
            ...
            c.setFont("Helvetica-Oblique", 8); c.drawString(60, y, "(Sin movimientos registrados este mes)")
            y -= 25
